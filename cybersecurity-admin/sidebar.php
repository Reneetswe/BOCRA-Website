<?php
/**
 * Cybersecurity Admin Portal - Sidebar Navigation
 */
...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="requests.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'requests.php' ? 'active' : ''; ?>">
            ...
            <?php
            $sql = "SELECT COUNT(*) as count FROM cybersecurity_requests WHERE status IN ('submitted', 'reviewing')";
            $result = dbQuery($sql);
        ...
        <a href="requests.php?filter=assigned_to_me" class="nav-link">
            <i class="fas fa-tasks"></i>
            <span>My Assignments</span>
        </a>
        
        <a href="requests.php?urgency=critical" class="nav-link">
        ...
        <div class="quick-stats">
            ...
            <div class="quick-stat">
                <div class="stat-value">
                    <?php
                    $sql = "SELECT COUNT(*) as count FROM cybersecurity_requests WHERE assigned_to = ? AND status = 'in_progress'";
                    $result = dbQuery($sql, [$_SESSION['user_id']]);
                    echo $result[0]['count'];
                    ?>
                </div>
